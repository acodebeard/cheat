...
final class CheatJS_Presets {
    ...
    public static function get_builtin_presets(): array {
        return [
            ...
            'fall_down'     => [
                'name'             => 'Fall Down',
                'description'      => 'Makes visible letters shake and fall away.',
                'effect_label'     => 'Fall down mode',
                'body_class'       => 'cheatjs-fall-down',
                'default_enabled'  => false,
                'default_sequence' => [ 'f', 'a', 'l', 'l' ],
                'on_message'       => 'Fall down mode enabled.',
                'off_message'      => 'Fall down mode disabled.',
            ],
            'grayscale'     => [
                'name'             => 'Grayscale',
            ...
            'runaway'       => [
                'name'             => 'Runaway',
                'description'      => 'Makes clickable elements dodge the cursor.',
                'effect_label'     => 'Runaway mode',
                'body_class'       => 'cheatjs-runaway',
                'default_enabled'  => false,
                'default_sequence' => [ 'r', 'u', 'n' ],
                'on_message'       => 'Runaway mode enabled.',
                'off_message'      => 'Runaway mode disabled.',
            ],
            'soft_blur'     => [
                'name'             => 'Soft Blur',
